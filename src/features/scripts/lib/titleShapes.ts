...
// (Built-in title shapes + templates copied verbatim from titleShapes.ts.)
//
// The built-in title shapes — the structural psychology behind why a title earns
// the click, plus a Formats shape for recurring container types. Slot patterns use
// our {curly} notation. Shipped as code constants (browse + use + install), with
// custom shapes stored per-project in bsp_title_shapes.
