      ...
      <div className="relative flex min-h-0 flex-1">
        ...
        <div ref={scrollRef} className="relative flex-1 overflow-y-auto">
          ...
          {/* Paragraphs are separate divs (split on blank lines) so the ←
              ...
              Side padding lives HERE, not on the scroller: the scroller is a
              flex item, so % padding on it would resolve against the flex row
              that also holds the rail (full screen width), making the text
              column shift whenever the rail opens or closes. On this child the
              % resolves against the scroller's own width. */}
          <div
            ref={contentRef}
