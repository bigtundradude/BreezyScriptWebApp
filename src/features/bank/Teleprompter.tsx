...
export function Teleprompter({
  ...
  // → jumps forward 20% of screen height. Space/arrows are ignored while a
  // control that uses them has focus so they still operate that control.
  // Arrows pass through a focused button (buttons don't use them), so
  // clicking Play doesn't strand the arrow keys until focus moves away;
  // Space on a focused button is left to the button's native activation.
