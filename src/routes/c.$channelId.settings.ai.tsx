...
import { AiIntegrationsSettings } from '@/features/settings/AiIntegrationsSettings'

export const Route = createFileRoute('/c/$channelId/settings/ai')({
  ...
  return (
    <div className="mx-auto flex w-full max-w-190 flex-col gap-4 px-4 py-5 pb-10 md:px-8 md:py-7 md:pb-12">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <h2 className="text-lg font-bold tracking-[-0.01em] text-text-primary">AI integrations</h2>
      </div>
