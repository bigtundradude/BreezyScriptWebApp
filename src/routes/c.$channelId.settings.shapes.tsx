...
import { TitleShapesSettings } from '@/features/settings/TitleShapesSettings'

export const Route = createFileRoute('/c/$channelId/settings/shapes')({
  component: ShapesSettingsPage,
})

function ShapesSettingsPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-190 flex-col gap-4 px-4 py-5 md:px-8 md:py-7">
      ...
      <TitleShapesSettings channelId={channelId as Id<'channels'>} />
    </div>
  )
}
